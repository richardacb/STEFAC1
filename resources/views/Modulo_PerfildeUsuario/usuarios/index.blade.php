                        ...
                        <td width="150px">
                            @can('Modulo_PerfildeUsuario.usuarios.edit')
                                <a class="btn btn-warning btn-sm "
                                    href="{{ route('usuarios.edit', $user->id) }}"><i class="fa fa-users-cog"></i></a>
                            @endcan
                            {{--  @can('Modulo_PerfildeUsuario.usuarios.editar')  --}}
                                 <a class="btn btn-primary btn-sm" href="{{ route('usuarios.editar', $user->id) }}"><i
                                        class="fa fa-edit"></i></a>
                            {{--  @endcan  --}}
                             {{--  @can('Modulo_PerfildeUsuario.usuarios.editar')  --}}
                             <a class="btn btn-success btn-sm" href="{{ route('usuarios.show', $user->id) }}"><i
