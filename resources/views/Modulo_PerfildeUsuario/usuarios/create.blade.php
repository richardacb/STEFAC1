                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('usuarios.store') }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="primer_nombre" type="text" class="form-control @error('primer_nombre') is-invalid @enderror" name="primer_nombre" value="{{ old('primer_nombre') }}"  autocomplete="primer_nombre" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <select name="tipo_de_usuario" id="tipo_de_usuario" class="form-control mr-sm-2 form-select form-control @error('tipo_de_usuario') is-invalid @enderror" value="{{ old('tipo_de_usuario') }}"  autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <select name="sexo" id="sexo" class="form-control mr-sm-2 form-select form-control @error('sexo') is-invalid @enderror" value="{{ old('sexo') }}"  autofocus>
                                            <option value="0" selected="selected">--Seleccione--</option>
                                ...
                                <div class="row mb-3">
                                    <label for="municipio" class="col-md-4 col-form-label text-md-end">{{ __('Año') }}</label>

                                    <div class="col-md-6">
                                        <input id="anno" type="number" min="1" max="5" class="form-control @error('anno') is-invalid @enderror" name="anno" value="{{ old('anno') }}"  autocomplete="anno" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="municipio" type="text" class="form-control @error('municipio') is-invalid @enderror" name="municipio" value="{{ old('municipio') }}"  autocomplete="municipio" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="provincia" type="text" class="form-control @error('provincia') is-invalid @enderror" name="provincia" value="{{ old('username') }}"  autocomplete="username" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <select name="color_piel" id="color_piel" class="form-control mr-sm-2 form-select form-control @error('sexo') is-invalid @enderror" value="{{ old('color_piel') }}"  autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="telefono_casa" type="text" class="form-control @error('telefono_casa') is-invalid @enderror" name="telefono_casa" value="{{ old('telefono_casa') }}"  autocomplete="username" autofocus>
