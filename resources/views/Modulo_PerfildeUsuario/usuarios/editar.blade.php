                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            {{-- <form method="POST" action="{{ route('usuarios.actualizar', ["id" => $users->id]) }}"> --}}
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="primer_nombre" type="text"
                                            ...
                                            name="primer_nombre" value="{{ $users->primer_nombre  }}" required
                                            autocomplete="primer_nombre" autofocus>
                                        @error('primer_nombre')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="segundo_nombre" type="text"
                                            ...
                                            name="segundo_nombre" value="{{ $users->segundo_nombre }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="primer_apellido" type="text"
                                            ...
                                            name="primer_apellido" value="{{ $users->primer_apellido }}" required
                                            autocomplete="primer_apellido" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="segundo_apellido" type="text"
                                            ...
                                            name="segundo_apellido" value="{{ $users->segundo_apellido }}" required
                                            autocomplete="segundo_apellido" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="ci" type="text"
                                            ...
                                            value="{{ $users->ci }}" required autocomplete="ci" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="password" type="password"
                                            ...
                                            name="password"  autocomplete="new-password" value="{{ $users->password }}" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="password-confirm" type="password" class="form-control"
                                            name="password_confirmation" value="{{ $users->password_confirmation }}" autocomplete="new-password">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="municipio" type="text"
                                            ...
                                            name="municipio" value="{{ $users->municipio }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="provincia" type="text"
                                            ...
                                            name="provincia" value="{{ $users->provincia }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="telefono_casa" type="text"
                                            class="form-control @error('telefono_casa') is-invalid @enderror"
                                            name="telefono_casa" value="{{ $users->telefono_casa }}" required
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="telefono_uci" type="text"
                                            class="form-control @error('telefono_uci') is-invalid @enderror"
                                            name="telefono_uci" value="{{ $users->telefono_uci }}"
                                            autocomplete="telefono_uci" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="celular" type="text"
                                            ...
                                            name="celular" value="{{ $users->celular }}" autocomplete="celular"
                                            autofocus>
                                ...
                                <div class="row mb-3">
                                    <label for="solapin"
                                        class="col-md-4 col-form-label text-md-end">{{ __('Solapin') }}</label>

                                    <div class="col-md-6">
                                        <input id="solapin" type="text"
                                            class="form-control @error('solapin') is-invalid @enderror"
                                            name="solapin" value="{{ $users->solapin }}" autocomplete="solapin"
                                            autofocus>
